...
class LarasettingCreateApplyIdentifiableTriggerFunction extends LarasettingMigration
{
    /**
     * Return table name
     *
    ...
    public function up()
    {
        DB::statement("
            ...
            LANGUAGE plpgsql AS $$
                BEGIN
                    PERFORM ".LarasettingCreateApplyIdentifiableFunction::table()."(TD['args'][0]);
                    RETURN NULL;
                END;
            $$;
        ");
